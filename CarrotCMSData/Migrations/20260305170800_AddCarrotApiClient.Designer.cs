...
namespace Carrotware.CMS.Data.Migrations
{
    ...
    [Migration("20260305170800_AddCarrotApiClient")]
    partial class AddCarrotApiClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carrotware.CMS.Data.Models.CarrotApiClient", b =>
                {
                    ...
                    b.HasIndex("ScopeToSiteId");

                    b.ToTable("CarrotApiClients", (string)null);
                });
            ...
            modelBuilder.Entity("Carrotware.CMS.Data.Models.CarrotApiClient", b =>
                {
                    b.HasOne("Carrotware.CMS.Data.Models.CarrotSite", "ScopeToSite")
                        .WithMany()
                        .HasForeignKey("ScopeToSiteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_CarrotApiClients_ScopeToSiteId");

                    b.Navigation("ScopeToSite");
                });
