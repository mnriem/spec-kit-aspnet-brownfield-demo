...
namespace Carrotware.CMS.Data.Models {
	...
	public partial class CarrotCakeContext : DbContext {
		...
		// headless API client credentials
		public virtual DbSet<CarrotApiClient> CarrotApiClients { get; set; } = null!;
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder) {
			...
			modelBuilder.Entity<CarrotApiClient>(entity => {
				entity.HasKey(e => e.ApiClientId);

				entity.ToTable("CarrotApiClients");
				...
				entity.HasOne(d => d.ScopeToSite)
					.WithMany()
					.HasForeignKey(d => d.ScopeToSiteId)
					.OnDelete(DeleteBehavior.Restrict)
					.HasConstraintName("FK_CarrotApiClients_ScopeToSiteId");
			});
		}
